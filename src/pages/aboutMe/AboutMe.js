...
const AboutMe = () => {
  return (
    <div className='bg-black' >
      <Navbar />
      <div className='t1t text-center mb-4'><h1 className='t1'>About <span>Me</span></h1></div>
      ...
      <div className='about'>
       ...
       <div className="left">
        ...
        <h3>Bogota</h3>  
        <p className="frase">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum necessitatibus sit qui eum nesciunt iure repudiandae itaque. Ad debitis cupiditate harum sint quo eveniet, aspernatur enim inventore asperiores sunt saepe.
        </p>
        <div className="redes">

        <ul>
          <li><a href=""><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
